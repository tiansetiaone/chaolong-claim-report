...
<li class="nav-item">
  ...
  <div class="content-wrapper">
   ...
   <!-- form define  -->
   <form action="count1tambahedit.php" method="POST" name="form_ct">
   ...
   <div class="col-md-12">
    ...
    <input type="text" class="form-control" id="inputidproduct" name="why_make" value="<?php echo $data['why_make'];?>">
  </div>
  <div class="col-md-12">
    <label for="inputproduct" class="form-label">Countermeasures</label>
    <input type="text" class="form-control" id="inputproduct" name="counter" value="<?php echo $data['counter'];?>">
  </div>
  <div class="col-md-12">
    <label for="inputmodel" class="form-label">PIC</label>
    <input type="text" class="form-control" id="inputmodel" name="pic1" value="<?php echo $data['pic1'];?>">
  </div>
  <div class="col-md-12">
    <label for="inputpd" class="form-label">Due Date</label>
    <input type="date" class="form-control" id="inputpd" name="duedate1" value="<?php echo $data['duedate1'];?>">
  </div>
  <div class="col-md-12">
    <label for="inputphenom" class="form-label">Confirm Result</label>
    <input type="text" class="form-control" id="inputphenom" name="cresult1" value="<?php echo $data['cresult1'];?>">
  </div>
<br/>
