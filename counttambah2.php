...
?>
   <!-- form define  -->
   <form action="count2tambahproses.php" method="POST" name="form_ct">
   <div class="col-md-7" style="max-width: 600px;">
   <div class="card card-warning">
   <div class="card-header" style="background-color:#8AAA45" >
    <h3 class="card-title" style="color:white">Add Data Countermeasures-2</h3>
    </div>
    <div class="card-body">
   <form class="row g-3">
   <div class="col-md-12">
   ...
   <div class="col-md-12">
    <label for="inputwm" class="form-label">Why Loose</label>
    <input type="text" class="form-control" id="inputidproduct" name="why_loose">
  </div>
  <div class="col-md-12">
    <label for="inputproduct" class="form-label">Countermeasures</label>
    <input type="text" class="form-control" id="inputproduct" name="counter2">
  </div>
  <div class="col-md-12">
    <label for="inputmodel" class="form-label">PIC</label>
    <input type="text" class="form-control" id="inputmodel" name="pic2">
  </div>
  <div class="col-md-12">
    <label for="inputpd" class="form-label">Due Date</label>
    <input type="date" class="form-control" id="inputpd" name="duedate2">
  </div>
  <div class="col-md-12">
    <label for="inputphenom" class="form-label">Confirm Result</label>
    <input type="text" class="form-control" id="inputphenom" name="cresult2">
  </div>
<br/>
