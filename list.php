...
<li class="nav-item">
  ...
  <div class="content-wrapper">
   ...
   <div class="card-header" style="background-color:#7145AA" >
                <h3 class="card-title" style="color:white">List</h3>
    </div>
    <div class="card-body">
  ...
  <tbody class="table-group-divider">
   <?php
include 'konfig.php';
$query = mysqli_query($conn, "SELECT * FROM data_claim INNER JOIN define_the_claim_situation ON data_claim.no_claim = define_the_claim_situation.no_claim");
// $query = "SELECT * FROM define_the_claim_situation";
// $query = "SELECT no_claim,part_name,emergency_action FROM data_claim INNER JOIN define_the_claim_situation ON no_claim=no_claim";
$no = 1;
...
<br/>
          ...
          <div> <a href="non.php"><button class="btn btn-primary me-md-2" style="background-color:green;padding-inline:30px;" type="button">Next</button></a> </div>
</div>
</div>
