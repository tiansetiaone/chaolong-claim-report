...
<div class="wrapper">
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="investigation.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>4M Anayze</p>
                </a>
              </li>
...
?>
   ...
   <div class="col-md-7" style="max-width : 800px;white-space:nowrap;">
   <div class="card card-warning">
   <div class="card-header" style="background-color:#AA4545" >
  <h3 class="card-title" style="color:white">Investigation Result ( By 4M Anayze )</h3>
    </div>
    <div class="card-body">
    <div class="col-12">
    <label for="inputmc" class="form-label">No Claim</label>
    <!-- <input type="text" class="form-control" onkeyup="isi_otomatis()" id="no_claim" name="no_claim"> -->
    <td> <select name="no_claim" id="no_claim" class="form-control">
  ...
  <div class="col-12">
  <label for="exampleFormControlTextarea1" class="form-label">Emergency Action and Investigation</label>
  <textarea  class="form-control" id="emergency_action" name="emergency_action" rows="3"></textarea>
</div>
</br>
<div class="col-12">
<label class="visually-hidden" for="specificSizeInputName">Name</label>
  ...
  <input style="display:none;" type="file" name="gambar" class="file" >
    <div class="input-group my-10">
    <input type="text" class="form-control" disabled placeholder="Upload Gambar" id="file">
    <div class="col-1">
    <button  type="button" id="pilih_gambar" class="btn-sbm"  style="height:41px;background-color:blue; border-color:white ;border-radius:5px;color:white;padding-inline:35px; padding-top:5px; padding-bottom:2px; margin-bottom:2px"><b>Upload Image</b></button>
  </div>
</div>
</div>
<div class="picture">
<img src="dist/img/default.png" id="preview" class="img-thumbnail">
</div>
  <div class="d-grid gap-2 d-md-flex justify-content-md-end" style="margin-left:600px;margin-bottom:20px;margin-top:20px;">
 <button class="btn btn-primary" name="brn_simpan" style="background-color:yellow;color:black" type="submit"><b>Submit</b></button>
</form> 
</div>
</div>
</div>

          <div> <a href="rootcause.php"><button class="btn btn-primary me-md-2" style="background-color:green;padding-inline:30px;" type="button">Next</button></a> </div>
              </div>
</div>
	...
	$(document).ready(function(){
		...
		$('#no_claim').change(function(){
			...
			$.ajax({
				...
				data: {no_claim:no_claim},	//Data send to the server to get the results
				success:function(data)		//If data fetched successfully from the server, execute this function
				{
					// console.log(data);
					$('#emergency_action').html(data);	//Print the fetched models in the section wih ID - #item
				}
			});
