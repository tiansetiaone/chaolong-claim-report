...
<li class="nav-item">
  ...
  <div class="content-wrapper">
   ...
   <!-- form define  -->
   <form action="count2tambahedit.php" method="POST" name="form_ct">
   ...
   <div class="col-md-12">
    ...
    <input type="number" class="form-control" id="inputidproduct" name="no_claim" value="<?php echo $data['no_claim'];?>" readonly>
  </div>
   <div class="col-md-12">
    <label for="inputwm" class="form-label">Why Make</label>
    <input type="text" class="form-control" id="inputidproduct" name="why_loose" value="<?php echo $data['why_loose'];?>">
  </div>
  <div class="col-md-12">
    <label for="inputproduct" class="form-label">Countermeasures</label>
    <input type="text" class="form-control" id="inputproduct" name="counter2" value="<?php echo $data['counter2'];?>">
  </div>
  <div class="col-md-12">
    <label for="inputmodel" class="form-label">PIC</label>
    <input type="text" class="form-control" id="inputmodel" name="pic2" value="<?php echo $data['pic2'];?>">
  </div>
  <div class="col-md-12">
    <label for="inputpd" class="form-label">Due Date</label>
    <input type="date" class="form-control" id="inputpd" name="duedate2" value="<?php echo $data['duedate2'];?>">
  </div>
  <div class="col-md-12">
    <label for="inputphenom" class="form-label">Confirm Result</label>
    <input type="text" class="form-control" id="inputphenom" name="cresult2" value="<?php echo $data['cresult2'];?>">
  </div>
<br/>
