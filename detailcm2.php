...
$query="SELECT * FROM countermeasures2 where no_claim=$no_claim";
...
<li class="nav-item">
  ...
  <div class="content-wrapper">
   ...
   <form class="row g-3">
   <div class="col-md-12">
    <label for="inputwm" class="form-label">ID</label>
   ...
   <div class="col-md-12">
    ...
    <input type="text" class="form-control" id="inputidproduct" name="why_make" value="<?php echo $data['why_loose'];?>" readonly>
  </div>
  <div class="col-md-12">
    <label for="inputproduct" class="form-label">Countermeasures</label>
    <input type="text" class="form-control" id="inputproduct" name="counter" value="<?php echo $data['counter2'];?>" readonly>
  </div>
  <div class="col-md-12">
    <label for="inputmodel" class="form-label">PIC</label>
    <input type="text" class="form-control" id="inputmodel" name="pic1" value="<?php echo $data['pic2'];?>" readonly>
  </div>
  <div class="col-md-12">
    <label for="inputpd" class="form-label">Due Date</label>
    <input type="date" class="form-control" id="inputpd" name="duedate1" value="<?php echo $data['duedate2'];?>" readonly>
  </div>
  <div class="col-md-12">
    <label for="inputphenom" class="form-label">Confirm Result</label>
    <input type="text" class="form-control" id="inputphenom" name="cresult1" value="<?php echo $data['cresult2'];?>" readonly>
  </div>
<br/>
