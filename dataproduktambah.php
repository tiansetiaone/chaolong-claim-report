...
<div class="wrapper">
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
            ...
            <li class="nav-item">
                <a href="dataproduk.php" class="nav-link active">
...
<li class="nav-item">
  ...
  <div class="content-wrapper">
   ...
   <!-- form define  -->
   <form action="produktambahproses.php" method="POST" name="form_pt">
   ...
   <form class="row g-3">
   <div class="col-md-12">
    <label for="inputidproduct" class="form-label">ID Product</label>
    <input type="number" class="form-control" id="inputidproduct" name="product_id">
  </div>
  <div class="col-md-12">
  ...
  <div class="col-md-12">
    <label for="inputphenom" class="form-label">Stock</label>
    <input type="text" class="form-control" id="inputphenom" name="stok">
  </div>
<br/>
  <div class="d-grid gap-2 d-md-flex justify-content-md-end" style="margin-left:400px;margin-bottom:30px;margin-top:20px;">
  <button class="btn btn-primary" style="background-color:blue;color:black" type="button" ><a href="dataproduk.php"><b>Back</b></a></button> &nbsp;&nbsp;
