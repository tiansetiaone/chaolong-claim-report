...
?>
  ...
  <div class="col-md-12">
    <label for="inputng" class="form-label">NG Qty/ Ratio</label>
...
<div> <a href="investigation.php"><button class="btn btn-primary me-md-2 mb-2" style="background-color:green;padding-inline:30px;" type="button">Next</button></a> </div>
 </div>
</div>
	...
	$(document).ready(function(){
		...
		$('#no_claim').change(function(){
			...
			$.ajax({
				...
				{
					// console.log(data);
					$('#product_name').html(data);	//Print the fetched models in the section wih ID - #item
				}
			});
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$('#product_name').change(function(){
			...
			// start Ajax call to get the models belongs to a particular brand_id
			$.ajax({
				url: "fetch_model2.php",		//Path for PHP file to fetch phone models from DB
				method: "POST",				//Fetching method
