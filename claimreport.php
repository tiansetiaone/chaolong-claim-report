...
<head>
  ...
  .card  {
    box-shadow : 2px 3px 20px rgb(170,170,170);
  }
  </style>
</head>
...
<div class="wrapper">
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="claimreport.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Data Claim</p>
                </a>
              </li>
...
<li class="nav-item">
  ...
  <div class="content-wrapper">
    ...
    <form action="claimtambah.php" method="POST" name="form_dc">
    <!-- Main content -->
    <div class="col-md-7" >
                <!-- general form elements disabled -->
                <div class="card card-warning" style="background-color:#AFBCC0;"  >
              ...
              <div class="card-body">
                  <div class="form-group row">
                    <label for="inputnumber" class="col-sm-2 col-form-label">No Claim</label>
                    <div class="col-sm-10">
                      <input type="number" class="form-control" id="inputnumber" name="no_claim" placeholder="No Claim">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputtext1" class="col-sm-2 col-form-label">Product</label>
                    <div class="col-sm-10">
                    <td> <select name="product_name" class="form-control" readonly>
                <?php
                include "konfig.php";
                //query menampilkan nama unit kerja ke dalam combobox
                $query    =mysqli_query($conn, "SELECT * FROM products GROUP BY product_name ORDER BY product_id");
                while ($data = mysqli_fetch_array($query)) {
                ?>
                <option value="<?=$data['product_name'];?>"><?php echo $data['product_name'];?></option>
                <?php
                }
                ?>
            </select></td>
                  ...
                  <div class="form-group row">
                    <label for="inputtext1" class="col-sm-2 col-form-label">Part Name</label>
                    <div class="col-sm-10">
                      <textarea type="text" class="form-control" rows="3" id="inputtext1" name="part_name" placeholder="Part Name"></textarea>
                    </div>
                  </div>
                </div>
                <fieldset>
                <legend><b>Made By</b></legend>
                  <div class="row">
                    <div class="col-sm-6">
                      <!-- checkbox -->
                      <div class="form-group2" style="margin-left:10px;display:flex;">
                      <div class="form-check" style="padding-right:20px;white-space: nowrap;">
                          <label class="form-check-label"><b>Checked By :</b></label>
                        </div>
                        <div class="form-check" style="padding-right:20px;white-space: nowrap;">
                          <input class="form-check-input" type="checkbox" name="checked_by" value="QC">
                          <label class="form-check-label">QC</label>
                        </div>
                        <div class="form-check" style="padding-right:20px;white-space: nowrap;">
                          <input class="form-check-input" type="checkbox" name="checked_by" value="SPV">
                          <label class="form-check-label">Spv</label>
                        </div>
                        <div class="form-check" style="padding-right:20px;white-space: nowrap;">
                          <input class="form-check-input" type="checkbox" name="checked_by" value="Manager">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group2" style="margin-left:10px;display:flex;">
                      <div class="form-check" style="padding-right:20px;white-space: nowrap;">
                          <label class="form-check-label"><b>Approved&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b></label>
                        </div>
                        <div class="form-check" style="padding-right:20px;white-space: nowrap;">
                          <input class="form-check-input" type="checkbox" name="approved_by" value="QC">
                          <label class="form-check-label">QC</label>
                        </div>
                        <div class="form-check" style="padding-right:20px;white-space: nowrap;">
                          <input class="form-check-input" type="checkbox" name="approved_by" value="SPV">
                          <label class="form-check-label">Spv</label>
                        </div>
                        <div class="form-check" style="padding-right:20px;white-space: nowrap;">
                          <input class="form-check-input" type="checkbox" name="approved_by" value="Manager">
                          <label class="form-check-label">Manager</label>
                        </div>
                      </div>
                      </fieldset>
          ...
          <div> <a href="define.php"><button class="btn btn-primary me-md-2 ml-2" style="background-color:green;padding-inline:30px;" type="button">Next</button></a> </div>
</div>
  <!-- /.content-wrapper -->
