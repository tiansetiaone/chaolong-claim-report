...
<div class="wrapper">
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="rootcause.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p> Root Cause</p>
                </a>
              </li>
...
?>
   <!-- form define  -->
   <form action="rcsimpan.php" method="post" name="form_rc">
   <div class="col-md-7" >
    
   <div class="card card-warning">
   <div class="card-header" style="background-color:#C1B650" >
                <h3 class="card-title" style="color:white">Investigation Result ( Root Cause )</h3>
    </div>
    <div class="card-body">
  ...
  <div class="col-12">
  <label for="exampleFormControlTextarea1" class="form-label">NG Product Inspection Result ( By Inspection Standard )</label>
  <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="ng_product" ></textarea>
</div>
<div class="col-12">
  <label for="exampleFormControlTextarea1" class="form-label">Procustion Procedure Investigation ( By Control Plan )</label>
  <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="procustion" ></textarea>
</div>
</form>
<div class="d-grid gap-2 d-md-flex justify-content-md-end" style="margin-left:430px;margin-bottom:20px;margin-top:20px;">
 <button class="btn btn-primary" style="background-color:yellow;color:black" name="Submit" value="Submit" type="submit"><b>Submit</b></button>
 </form>  
</div>
  </div>
</div>
          <div> <a href="countermeasures.php"><button class="btn btn-primary me-md-2" style="background-color:green;padding-inline:30px;" type="button">Next</button></a> </div>
</div>
</div>
