  ...
  <div class="content-wrapper">
   ...
   <div class="col-md-7" >
    ...
    <div class="card-header" style="background-color:#8AAA45" >
                 <h3 class="card-title" style="color:white">Data Product</h3>
     </div>
     <div class="card-body">
     <div class="btn-group w-100">
     <a href="dataproduktambah.php"><span class="btn btn-success col fileinput-button">
                        <i class="fas fa-plus"></i>
                        <span>Add Product</span>
                      </span></a>
    </div>
     <form class="row row-cols-lg-auto g-3 align-items-center" style="padding-top:20px;">
...
$d = $row['pro_date'];
$e = $row['stok'];
echo "<tr><td>$no</td><td>$a</td><td>$b</td><td>$c</td><td>$d</td><td>$e</td>";
$no++;
}
?>
   </tbody>
