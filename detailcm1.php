...
?>
<?php $no_claim= $_GET['no_claim'];
$query="SELECT * FROM countermeasures1 where no_claim=$no_claim";
...
<li class="nav-item">
  ...
  <div class="content-wrapper">
   ...
   <!-- form define  -->
   <form action="" method="POST" name="form_ct">
   ...
   <form class="row g-3">
   <div class="col-md-12">
    <label for="inputwm" class="form-label">No Claim</label>
    <input type="text" class="form-control" id="inputidproduct" name="no_claim" value="<?php echo $data['no_claim'];?>" readonly>
  </div>
   <div class="col-md-12">
    <label for="inputwm" class="form-label">Why Make</label>
    <input type="text" class="form-control" id="inputidproduct" name="why_make" value="<?php echo $data['why_make'];?>" readonly>
  </div>
  <div class="col-md-12">
    <label for="inputproduct" class="form-label">Countermeasures</label>
    <input type="text" class="form-control" id="inputproduct" name="counter" value="<?php echo $data['counter'];?>" readonly>
  </div>
  <div class="col-md-12">
    <label for="inputmodel" class="form-label">PIC</label>
    <input type="text" class="form-control" id="inputmodel" name="pic1" value="<?php echo $data['pic1'];?>" readonly>
  </div>
  <div class="col-md-12">
    <label for="inputpd" class="form-label">Due Date</label>
    <input type="date" class="form-control" id="inputpd" name="duedate1" value="<?php echo $data['duedate1'];?>" readonly>
  </div>
  <div class="col-md-12">
    <label for="inputphenom" class="form-label">Confirm Result</label>
    <input type="text" class="form-control" id="inputphenom" name="cresult1" value="<?php echo $data['cresult1'];?>" readonly>
  </div>
<br/>
